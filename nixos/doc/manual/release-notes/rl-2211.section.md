...
- The [`blst`](https://github.com/supranational/blst), a library that supports algebraic operations over Elliptic Curve BLS12-381, is now included as a nix package.
